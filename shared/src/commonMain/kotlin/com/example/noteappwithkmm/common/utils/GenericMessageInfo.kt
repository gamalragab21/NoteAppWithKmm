...
private constructor(builder: Builder){
    ...
    class Builder {
        ...
        override fun toString(): String {
            return "Builder(id=$id, title=$title, onDismiss=$onDismiss, uiComponentType=$uiComponentType, description=$description, positiveAction=$positiveAction, negativeAction=$negativeAction)"
        }
